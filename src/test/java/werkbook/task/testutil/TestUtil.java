...
import werkbook.task.commons.util.XmlUtil;
...
import werkbook.task.storage.XmlSerializableTaskList;
...
public class TestUtil {
     ...
     * @param tasksToAdd The tasks that are to be appended behind the
     *            original array.
