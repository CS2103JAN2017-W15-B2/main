        ...
        try {
            return new Task[] {
                new Task(new Name("Walk the dog"),
                        ...
                        Optional.of(new StartDateTime("03/01/2016 0900")),
                        Optional.of(new EndDateTime("03/01/2016 1100")),
                        new UniqueTagList("Incomplete")),
                new Task(new Name("Get groceries"), new Description("Egg, cheese, and milk"),
                        Optional.of(new StartDateTime("10/01/2016 1900")),
                        Optional.of(new EndDateTime("10/01/2016 2100")),
                        new UniqueTagList("Incomplete")),
                new Task(new Name("Finish report"), new Description("Do up citations and references"),
                        Optional.of(new StartDateTime("15/03/2016 1000")),
                        Optional.of(new EndDateTime("23/03/2016 2359")),
                        new UniqueTagList("Incomplete")),
                new Task(new Name("Take out the trash"), new Description(""),
                        Optional.of(new StartDateTime("25/12/2015 1400")),
                        Optional.of(new EndDateTime("25/12/2015 1415")),
                        new UniqueTagList("Completed")),
                new Task(new Name("Do Christmas shopping"), new Description("Compare prices with Amazon"),
                        Optional.of(new StartDateTime("20/12/2015 1200")),
                        Optional.of(new EndDateTime("24/12/2015 2200")),
                        new UniqueTagList("Complete")),
                new Task(new Name("Learn how to cook"), new Description("Google instant noodle recipes"),
                        Optional.of(new StartDateTime("11/11/2015 0900")),
                        Optional.of(new EndDateTime("11/11/2015 1900")),
                        new UniqueTagList("Complete")) };
